...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name containersBayModelModalController
   * @ngController
   *
   * @description
  ...
  angular
    ...
    .controller('containersBayModelModalController', containersBayModelModalController);

  containersBayModelModalController.$inject = [
    '$modal',
    '$window',
  ...
  function containersBayModelModalController($modal, $window, basePath, magnum) {
    var ctrl = this;

    ctrl.openBayModelCreateWizard = openBayModelCreateWizard;

    function openBayModelCreateWizard(launchContext) {
      var options = {
        controller: 'ModalContainerController',
        backdrop: 'static',
        template: '<wizard ng-controller="createBayModelWizardController"></wizard>',
